...
export class Faq {
  readonly questions: FaqI[] = [
...

    {
      ...
      answer: 'Sí. Cada obra se realiza desde cero y adaptada a las preferencias del cliente.',
    },
...

    {
      ...
      answer: 'Sí. Una vez terminada la obra se prepara cuidadosamente para su envío.',
    },
