...
document.addEventListener("DOMContentLoaded", () => {
   ...
   */
  var galleryContainer = document.getElementById("galleryNaturalezaContainer");
  var imageFolder = "../assets/img/galeria/paisajesNaturales/";
  var totalImages = 5;

  for (var i = 1; i <= totalImages; i++) {
    var imageSrc = imageFolder + "naturaleza_" + i + ".jpg";
